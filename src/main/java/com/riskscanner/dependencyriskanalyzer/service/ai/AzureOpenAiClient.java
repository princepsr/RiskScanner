...
/**
 * Azure OpenAI implementation of {@link AiClient}.
 *
 * <p>Uses the Azure OpenAI chat completions API. The model should be the deployment name
 * you configured in Azure OpenAI (e.g., gpt-4o, gpt-4o-mini). The apiKey is the Azure
 * OpenAI key, and the endpoint is your Azure OpenAI resource URL.
 */
public class AzureOpenAiClient implements AiClient {
    ...
    public AzureOpenAiClient(String apiKey, String endpoint, String model) {
        this.openAiService = new OpenAiService(apiKey, java.time.Duration.ofSeconds(30));
        this.model = model;
    }
